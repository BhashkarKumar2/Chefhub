      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        {filteredBookings.length === 0 ? (
          <div className="text-center py-16">
            ...
            <Link to="/chefs" className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-orange-600 to-amber-600 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-semibold">
