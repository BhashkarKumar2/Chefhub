...
const SignupNew = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden">
      ...
      {/* Signup card */}
      <div className="relative z-10 w-full max-w-2xl mx-auto rounded-2xl shadow-2xl bg-white/80 backdrop-blur-md border border-blue-200/40 p-10 flex flex-col items-center">
