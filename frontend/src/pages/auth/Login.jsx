...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-md mx-auto rounded-2xl shadow-2xl bg-white/80 backdrop-blur-md border border-blue-200/40 p-6 sm:p-8 flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-4">
            ...
            <input
              ...
              id="email"
              name="email"
            className="w-full p-3 sm:p-4 border border-gray-300 rounded-lg text-gray-900 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:text-base"
        ...
        <div className="flex justify-center gap-3 mb-4">
          <button
            ...
            className="p-3 sm:p-4 border border-gray-300 rounded-full bg-white hover:shadow-md transition min-h-[48px] min-w-[48px]"
          >
            <img
          ...
          <button
            ...
            className="p-3 sm:p-4 border border-gray-300 rounded-full bg-white hover:shadow-md transition min-h-[48px] min-w-[48px] flex items-center justify-center"
          >
