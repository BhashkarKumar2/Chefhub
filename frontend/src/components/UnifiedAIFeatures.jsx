      ...
      {menu && (
        <div className="space-y-6">
          {menu.error ? (
            ...
            <>
              <div>
                <h4 className={`font-semibold text-lg mb-2 ${classes.text.heading}`}>ðŸ¥— Appetizers</h4>
              ...
              <div>
                <h4 className={`font-semibold text-lg mb-2 ${classes.text.heading}`}>ðŸ› Main Course</h4>
                <ul className="list-disc list-inside space-y-1">
              ...
              <div>
                <h4 className={`font-semibold text-lg mb-2 ${classes.text.heading}`}>ðŸ° Desserts</h4>
                <ul className="list-disc list-inside space-y-1">
    ...
    <div className={`${classes.bg.card} rounded-lg shadow-lg border ${classes.border.default} flex flex-col h-[600px]`}>
      ...
      <div className={`p-4 border-t ${classes.border.default} ${isDark ? 'bg-gray-900/50' : 'bg-stone-50/50'}`}>
        ...
        <p className={`text-xs ${classes.text.muted} mt-2 text-center`}>
          Powered by AI â€¢ Ask about recipes, cooking tips, ingredients & more
        </p>
      </div>
    </div>
  );
              ...
              <div>
                ...
                <div className={`${classes.bg.card} rounded-lg shadow-lg p-6 mb-6 border ${classes.border.default}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className={`block text-sm font-medium ${classes.text.primary} mb-1`}>Budget (â‚¹)</label>
                      <input
                        type="number"
